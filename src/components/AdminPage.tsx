...
const statusLabels: Record<string, string> = { new: '신규', reviewing: '검토 중', consultation_scheduled: '상담 예정', proposal_sent: '제안서 발송', contracted: '계약 완료' };
